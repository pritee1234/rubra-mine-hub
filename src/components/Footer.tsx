        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-mining-200 mb-4">
              ...
              bringing expertise in Coal, Iron Ore, Copper, and Gold.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-mining-200 hover:text-mining-accent transition-colors">
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-display font-medium mb-4">Contact Us</h3>
            <ul className="space-y-4">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 text-mining-accent mr-3 mt-0.5" />
                <span className="text-mining-200">123 Mining Avenue, Perth, Australia</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-mining-accent mr-3" />
                <a href="tel:+61412345678" className="text-mining-200 hover:text-mining-accent transition-colors">+61 4 1234 5678</a>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-mining-accent mr-3" />
                <a href="mailto:info@rubramining.com" className="text-mining-200 hover:text-mining-accent transition-colors">info@rubramining.com</a>
              </li>
            </ul>
          </div>
        </div>
